        ...
        return (
            <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
                ...
                <Field
                    ...
                    hint={t(data.autoGenerateTitle)}
                    description={t(data.autoGenerateDescription)}
    ...
    PAYMENT_CUSTOMIZE_TAB = () => {
        ...
        if (!PermissionService.isAllowToView(CUSTOMIZE_TYPE.PAYMENTS)) {
            return (
                ...
                >
                    {this.PREFIX_FIELD(data)}
                    {this.TEXTAREA_FIELDS()}
                    {this.TOGGLE_FIELD_VIEW(data)}
                </ScrollView>
            );
        }
